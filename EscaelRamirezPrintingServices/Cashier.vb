...
Public Class Cashier
    ...
    Private Sub Button29_Click_1(sender As Object, e As EventArgs) Handles Button29.Click
        ...
        Dim paymentInformation As String = PaymentTextBox.Text.Trim()
            ...
            If Not String.IsNullOrEmpty(paymentOption) Then
                ...
                'updte the quaantity of product if cashier add the product
    ...
    Private Sub UpdatePrice_TextChanged(sender As Object, e As EventArgs) Handles UpdatePrice.TextChanged

    End Sub

    Private Sub UpdatePrice_KeyPress(sender As Object, e As KeyPressEventArgs) Handles UpdatePrice.KeyPress
        If Not Char.IsDigit(e.KeyChar) AndAlso Not Char.IsControl(e.KeyChar) Then
            e.Handled = True
        End If
    End Sub
