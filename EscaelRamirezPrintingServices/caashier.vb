...
Public Class caashier
    ...
    Public Sub InsertDB()
        ...
        Try
            ...
            Dim querys As String = "INSERT INTO OrderReceived (refNum, Customer_Name, [Date], Total, id, Contact_Number, Address) VALUES (@refNum, @Customer_Name, GETDATE(), @TotalValue2, @id, @Contact_Number, @Address)"
            ...
            cmds.Parameters.AddWithValue("@TotalValue2", HoldPrice)
